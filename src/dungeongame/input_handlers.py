...
from .color import impossible, invalid, white, black, red
...
class PopupMessage(BaseEventHandler):
    ...
    def on_render(self, console: tcod.Console) -> None:
        ...
        console.print(console.width // 2, console.height // 2, self.text, fg=white, bg=black, alignment=libtcodpy.CENTER)
...
class AreaRangedAttackHandler(SelectIndexHandler):
    ...
    def on_render(self, console: tcod.Console) -> None:
        ...
        console.draw_frame(x=x - self.radius - 1, y=y - self.radius - 1, width=self.radius ** 2, height=self.radius ** 2, fg=red, clear=False)
